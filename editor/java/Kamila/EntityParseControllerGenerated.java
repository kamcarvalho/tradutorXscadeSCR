...
public class EntityParseControllerGenerated extends DynamicParseController 
{ 
  ...
  { 
    EntityParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = EntityParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = EntityParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(EntityParseControllerGenerated.class);
    }
